  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 w-full px-3 sm:px-6 pointer-events-none">
      ...
      >
        ...
        >
          <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center text-white shadow-[2px_4px_8px_rgba(99,102,241,0.35),inset_1px_1px_2px_rgba(255,255,255,0.4)] group-hover:scale-105 transition-transform overflow-hidden">
            <img src="/file_0000000061ec8208b8558503bdf167ad.png" alt="Logo" className="w-full h-full object-contain" />
          </div>
