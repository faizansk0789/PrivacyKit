        ...
        <div className="space-y-8 animate-fadeIn">
          ...
          <div className="clay-card p-5 sm:p-8 flex flex-col md:flex-row items-center justify-between gap-5 sm:gap-6 w-full overflow-hidden">
            <div className="flex items-center gap-4 sm:gap-5 w-full md:w-auto min-w-0">
              <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl clay-icon-pod text-amber-600 dark:text-amber-400 flex items-center justify-center shrink-0">
                <FileSpreadsheet className="w-6 h-6 sm:w-7 sm:h-7" />
              </div>
              <div className="space-y-1 min-w-0 flex-1">
                <span className="text-xs font-mono text-slate-500 dark:text-slate-400 uppercase tracking-wider block">Target Document</span>
                <h2 className="text-base sm:text-lg font-bold text-slate-900 dark:text-white truncate block" title={docData.fileName}>
                  {docData.fileName}
                </h2>
